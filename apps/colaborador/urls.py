...
from .views import editar_colaborador, criar_colaborador, retornar_dados_importantes,retorna_detalhes_colaboradores,quantidade_de_colaboradores,deletar_colaborador
